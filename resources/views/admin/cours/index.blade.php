    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Cour">
                    <thead>
                        <tr>
                            <th width="10">
                        ...
                        @foreach ($cours as $key => $cour)
                            <tr data-entry-id="{{ $cour->id }}">
                                ...
                                <td>
                                    ...
                                    @can('cour_delete')
                                        <form action="{{ route('admin.cours.destroy', $cour->id) }}" method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Cour:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
