            ...
            <div class="g-col-12 g-col-xl-4 mt-6">
                ...
                <div class="mt-5">
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('dist/images/profile-1.jpg') }}">
                            </div>
                            <div class="ms-4 me-auto">
                                <div class="fw-medium">Johnny Depp</div>
                                <div class="text-gray-600 fs-xs mt-0.5">14 July 2022</div>
                            </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('dist/images/profile-11.jpg') }}">
                            </div>
                            <div class="ms-4 me-auto">
                                <div class="fw-medium">Kate Winslet</div>
                                <div class="text-gray-600 fs-xs mt-0.5">15 May 2021</div>
                            </div>
                            <div class="py-1 px-2 rounded-pill fs-xs bg-theme-9 text-white cursor-pointer fw-medium">137 Sales</div>
                        </div>
                    </div>
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('dist/images/profile-9.jpg') }}">
                            </div>
                            <div class="ms-4 me-auto">
                                <div class="fw-medium">Leonardo DiCaprio</div>
                                <div class="text-gray-600 fs-xs mt-0.5">10 December 2022</div>
                            </div>
                            <div class="py-1 px-2 rounded-pill fs-xs bg-theme-9 text-white cursor-pointer fw-medium">137 Sales</div>
                        </div>
                    </div>
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('dist/images/profile-14.jpg') }}">
                            </div>
                            <div class="ms-4 me-auto">
                                <div class="fw-medium">Johnny Depp</div>
                                <div class="text-gray-600 fs-xs mt-0.5">18 December 2021</div>
                            </div>
                            <div class="py-1 px-2 rounded-pill fs-xs bg-theme-9 text-white cursor-pointer fw-medium">137 Sales</div>
                        </div>
                    </div>
                    <a href="" class="intro-y w-full d-block text-center rounded-2 py-4 border border-dotted border-theme-15 dark-border-dark-5 text-theme-16 dark-text-gray-600">View More</a>
                </div>
            </div>
                        ...
                        <tbody>
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="d-flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-9.jpg') }}" title="Uploaded at 14 July 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-12.jpg') }}" title="Uploaded at 7 May 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-13.jpg') }}" title="Uploaded at 29 December 2020">
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <a class="d-flex align-items-center text-theme-6" href=""> <i data-feather="trash-2" class="w-4 h-4 me-1"></i> Delete </a>
                                    </div>
                                </td>
                            </tr>
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="d-flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-4.jpg') }}" title="Uploaded at 15 May 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-14.jpg') }}" title="Uploaded at 6 November 2020">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-11.jpg') }}" title="Uploaded at 21 November 2022">
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <a href="" class="fw-medium text-nowrap">Oppo Find X2 Pro</a>
                                    <div class="text-gray-600 fs-xs text-nowrap mt-0.5">Smartphone &amp; Tablet</div>
                                </td>
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="d-flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-4.jpg') }}" title="Uploaded at 10 December 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-3.jpg') }}" title="Uploaded at 25 July 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-10.jpg') }}" title="Uploaded at 30 November 2021">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr class="intro-x">
                                <td class="w-40">
                                    <div class="d-flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-1.jpg') }}" title="Uploaded at 18 December 2021">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-9.jpg') }}" title="Uploaded at 5 December 2022">
                                        </div>
                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('dist/images/preview-7.jpg') }}" title="Uploaded at 12 July 2020">
                                        </div>
                                    </div>
                                </td>
                                <td>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 d-flex align-items-center zoom-in">
                                ...
                                <div class="text-theme-9">+$194</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 d-flex align-items-center zoom-in">
                                ...
                                <div class="ms-4 me-auto">
                                    <div class="fw-medium">Arnold Schwarzenegger</div>
                                    <div class="text-gray-600 fs-xs mt-0.5">31 May 2022</div>
                                </div>
                                <div class="text-theme-6">-$143</div>
                            </div>
                        </div>
                        <a href="" class="intro-x w-full d-block text-center rounded-2 py-3 border border-dotted border-theme-15 dark-border-dark-5 text-theme-16 dark-text-gray-600">View More</a>
                    </div>
                </div>
                <!-- END: Transactions -->
                    ...
                    <div class="report-timeline mt-5 position-relative">
                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                            <div class="report-timeline__image">
                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                    <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('dist/images/profile-2.jpg') }}">
                                </div>
                            </div>
                            <div class="box px-5 py-3 ms-4 flex-1 zoom-in">
                                <div class="d-flex align-items-center">
                                    <div class="fw-medium">Al Pacino</div>
                                ...
                                <div class="text-gray-600">
                                    ...
                                    <div class="d-flex mt-2">
                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Dell XPS 13">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{ asset('dist/images/preview-14.jpg') }}">
                                        </div>
                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Oppo Find X2 Pro">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{ asset('dist/images/preview-6.jpg') }}">
                                        </div>
                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Apple MacBook Pro 13">
                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{ asset('dist/images/preview-14.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                            <div class="report-timeline__image">
                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                    <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('dist/images/profile-6.jpg') }}">
                                </div>
                            </div>
                            <div class="box px-5 py-3 ms-4 flex-1 zoom-in">
                                <div class="d-flex align-items-center">
                                    <div class="fw-medium">Nicolas Cage</div>
                                    <div class="fs-xs text-gray-500 ms-auto">07:00 PM</div>
                                </div>
                        ...
                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                            <div class="report-timeline__image">
                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                    <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('dist/images/profile-8.jpg') }}">
                                </div>
                            </div>
                            <div class="box px-5 py-3 ms-4 flex-1 zoom-in">
                                <div class="d-flex align-items-center">
                                    <div class="fw-medium">Kevin Spacey</div>
                                    <div class="fs-xs text-gray-500 ms-auto">07:00 PM</div>
                                </div>
